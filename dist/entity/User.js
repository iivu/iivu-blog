...
var User = (_dec = (0, _typeorm.Entity)('users'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('increment'), _dec3 = (0, _typeorm.Column)('varchar'), _dec4 = (0, _typeorm.Column)('varchar'), _dec5 = (0, _typeorm.CreateDateColumn)(), _dec6 = (0, _typeorm.CreateDateColumn)(), _dec7 = (0, _typeorm.OneToMany)(function (type) {
  return _Post.Post;
}, function (post) {
  return post.author;
  ...
  (0, _createClass2["default"])(User, [{
    key: "createPasswordDigest",
    value: function createPasswordDigest() {
  ...
  writable: true,
  initializer: null
}), (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "createPasswordDigest", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "createPasswordDigest"), _class2.prototype)), _class2)) || _class);
exports.User = User;